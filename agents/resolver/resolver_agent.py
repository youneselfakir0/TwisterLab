...
class ResolverAgent(TwisterAgent):
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            ...
                            "sop_id": {"type": "string", "description": "SOP to execute"},
                            "strategy": {
                                "type": "string",
    ...
    async def execute(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(
                f"[{self.name}] Resolution failed for ticket {ticket_id}: {e}", exc_info=True
            )
    ...
    async def _execute_manual(
        self, ticket_id: str, sop: Optional[Dict[str, Any]], task_context: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
    ...
    async def _execute_step(
        ...
        if step_type == "command":
            ...
            return {"output": "Verification step completed", "resolution_confirmed": False}
