# TwisterLab LLM Deployment Script - Simplified
...
Write-Host "`nTime: $([math]::Round($Duration.TotalSeconds))s" -ForegroundColor White
...
Write-Host "`nNext: Open Grafana → LLM Agents Performance dashboard`n" -ForegroundColor Cyan
