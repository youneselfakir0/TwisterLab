...
with open('monitoring/grafana/provisioning/dashboards/twisterlab-agents-realtime.json', 'r', encoding='utf-8') as f:
...
for panel in panels:
    ...
    # Fix Panel 5 - API Request Rate
        ...
        panel['targets'][0]['expr'] = 'sum(rate(http_requests_total{job="twisterlab-api"}[1m])) by (method, endpoint)'
...
with open('monitoring/grafana/provisioning/dashboards/twisterlab-agents-realtime.json', 'w', encoding='utf-8') as f:
