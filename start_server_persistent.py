...
logging.basicConfig(
    ...
    handlers=[logging.StreamHandler(sys.stdout), logging.FileHandler("api_server.log")],
)
...
def main():
    ...
    try:
        ...
        config = Config(app=app, host="127.0.0.1", port=8000, log_level="info", access_log=True)
