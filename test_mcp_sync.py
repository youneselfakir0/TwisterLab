...
test_mcp_method(
    "tools/call",
    {"name": "classify_ticket", "arguments": {"ticket_text": "Cannot connect to WiFi eduroam"}},
)

# Test 4: Call monitor_system_health
test_mcp_method("tools/call", {"name": "monitor_system_health", "arguments": {}})

# Test 5: List resources
test_mcp_method("resources/list")

# Test 6: Read health resource
test_mcp_method("resources/read", {"uri": "twisterlab://system/health"})
